...
//Mean if we want to send response for a speacific path or wanna send multiple responses for multiple paths then we can do this using get method.get methos takes two parameters one is path and other is callback.This is alternate of use method for sending response but it is used when we have to send some specific responses for specific paths.
